...
import { createSnippetSchema, paramsIdSchema, updateSnippetSchema, snippetQuerySchema } from "../validation/snippet.validation";
...
router.post("/:id/fork", authMiddleware, validate(paramsIdSchema, "params"), snippetController.fork);
